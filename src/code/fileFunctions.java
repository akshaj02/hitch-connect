...
public class fileFunctions {
    ...
    public static void writeFile(String fileName, String cardNum, String expiry, String cvv, String name) {
        try {
            Files.write(Paths.get("otherFiles/" + fileName), (cardNum + "," + expiry + "," + cvv + "," + name + "\n").getBytes(), 
            StandardOpenOption.APPEND);
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static void writeFile(String fileName, String location, String destination, String username) {
        try {
            Files.write(Paths.get("otherFiles/" + fileName), (location + "," + destination + "," + username + "\n").getBytes(), 
            StandardOpenOption.APPEND);
        } catch (Exception e) {
            e.printStackTrace();
        }
